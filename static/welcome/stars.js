...
const minSpeed = 30;   // Increased minimum speed
const maxSpeed = 60;   // Increased maximum speed
...
function scheduleMeteor() {
    ...
    setTimeout(() => {
        // Spawn 1-10 meteors per burst
        const meteorCount = Math.floor(Math.random() * 10) + 1;
